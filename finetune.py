...
def train(
    ...
    prompter = Prompter(prompt_template_name) # 数据处理工具，组装数据用
    ...
    tokenizer = LlamaTokenizer.from_pretrained(base_model) #加载token
    ...
    model = prepare_model_for_int8_training(model) # 加载模型
